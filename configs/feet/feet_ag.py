...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook', init_kwargs=dict(project='mmdetection-tools', name='feet_ag'))
    ])
...
test_cfg = dict(
    rcnn=dict(
        ...
        max_per_img=100))
model = dict(roi_head=dict(bbox_head=dict(reg_class_agnostic=False, num_classes=1)))
