...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook', init_kwargs=dict(project='mmdetection-tools', name='feet_pseudo'))
    ])
...
test_cfg = dict(
    rcnn=dict(
        ...
        max_per_img=100))
model = dict(backbone=dict(frozen_stages=4),roi_head=dict(bbox_head=dict(num_classes=1)))
load_from = './work_dirs/feet_low/epoch_17.pth'
