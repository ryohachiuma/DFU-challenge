...
class SEBottleneck(Bottleneck):
    ...
    def __init__(self, inplanes, planes, groups, reduction, stride=1,norm_cfg=dict(type='BN'),
                 downsample=None):
...
class SENet(nn.Module):
    ...
    def __init__(self, block, layers, groups, reduction, dropout_p=0.0,
                 inplanes=128, input_3x3=False, downsample_kernel_size=3,
